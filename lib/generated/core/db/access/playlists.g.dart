...
mixin _$PlaylistsDaoMixin on DatabaseAccessor<Database> {
  ...
  $PlaylistSnippetsTable get playlistSnippets => attachedDatabase.playlistSnippets;
  $PlaylistThumbnailsTable get playlistThumbnails => attachedDatabase.playlistThumbnails;
  ...
  $PlaylistVsVideosTable get playlistVsVideos => attachedDatabase.playlistVsVideos;
}
