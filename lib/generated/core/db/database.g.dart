...
class $SeriesTable extends Series with TableInfo<$SeriesTable, Sery> {
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('data_hash')) {
      context.handle(
        _dataHashMeta,
        dataHash.isAcceptableOrUnknown(data['data_hash']!, _dataHashMeta),
      );
    }
    if (data.containsKey('priority')) {
      context.handle(
  ...
  Sery map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Sery(
      ...
      dataHash: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}data_hash'],
      ),
      priority: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}priority'],
...
class Sery extends DataClass implements Insertable<Sery> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['name'] = Variable<String>(name);
    map['description'] = Variable<String>(description);
    if (!nullToAbsent || dataPath != null) {
      map['data_path'] = Variable<String>(dataPath);
    }
    if (!nullToAbsent || dataHash != null) {
      map['data_hash'] = Variable<String>(dataHash);
    }
    map['priority'] = Variable<int>(priority);
    return map;
  }
  ...
  factory Sery.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    ...
    return Sery(
      ...
      dataHash: serializer.fromJson<String?>(json['dataHash']),
      priority: serializer.fromJson<int>(json['priority']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'dataHash': serializer.toJson<String?>(dataHash),
      'priority': serializer.toJson<int>(priority),
    };
  }
  ...
  Sery copyWith({
    ...
    Value<String?> dataHash = const Value.absent(),
    int? priority,
  }) => Sery(
    createdAt: createdAt ?? this.createdAt,
    updatedAt: updatedAt ?? this.updatedAt,
    ...
    name: name ?? this.name,
    description: description ?? this.description,
    dataPath: dataPath.present ? dataPath.value : this.dataPath,
    dataHash: dataHash.present ? dataHash.value : this.dataHash,
    priority: priority ?? this.priority,
  );
...
class SeriesCompanion extends UpdateCompanion<Sery> {
  ...
  const SeriesCompanion({
    ...
    this.dataHash = const Value.absent(),
    this.priority = const Value.absent(),
  });
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (dataHash.present) {
      map['data_hash'] = Variable<String>(dataHash.value);
    }
    if (priority.present) {
      map['priority'] = Variable<int>(priority.value);
    }
...
class $$VideoProgressTableTableManager
    extends
        RootTableManager<
          ...
          (
            VideoProgressData,
            BaseReferences<_$Database, $VideoProgressTable, VideoProgressData>,
          ),
          VideoProgressData,
          PrefetchHooks Function()
        > {
...
class $$SeriesTableFilterComposer extends Composer<_$Database, $SeriesTable> {
  ...
  ColumnFilters<String> get dataHash => $composableBuilder(
    column: $table.dataHash,
    builder: (column) => ColumnFilters(column),
  );
...
class $$SeriesTableOrderingComposer extends Composer<_$Database, $SeriesTable> {
  ...
  ColumnOrderings<String> get dataHash => $composableBuilder(
    column: $table.dataHash,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$SeriesTableAnnotationComposer extends Composer<_$Database, $SeriesTable> {
  ...
  GeneratedColumn<String> get dataHash =>
      $composableBuilder(column: $table.dataHash, builder: (column) => column);
