...
part of '../../../core/binge/binge_filter.dart';
...
mixin _$BingeFilter {
 ...
 BingeFilterWatchType get watchType; DateTime? get fromRange; DateTime? get toRange; String? get searchValue;
...
@override
int get hashCode => Object.hash(runtimeType,watchType,fromRange,toRange,searchValue);

@override
String toString() {
  return 'BingeFilter(watchType: $watchType, fromRange: $fromRange, toRange: $toRange, searchValue: $searchValue)';
}
...
@useResult
$Res call({
 BingeFilterWatchType watchType, DateTime? fromRange, DateTime? toRange, String? searchValue
});
...
/// Create a copy of BingeFilter
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? watchType = null,Object? fromRange = freezed,Object? toRange = freezed,Object? searchValue = freezed,}) {
  return _then(_self.copyWith(
watchType: null == watchType ? _self.watchType : watchType // ignore: cast_nullable_to_non_nullable
as BingeFilterWatchType,fromRange: freezed == fromRange ? _self.fromRange : fromRange // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( BingeFilterWatchType watchType,  DateTime? fromRange,  DateTime? toRange,  String? searchValue)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BingeFilter() when $default != null:
return $default(_that.watchType,_that.fromRange,_that.toRange,_that.searchValue);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( BingeFilterWatchType watchType,  DateTime? fromRange,  DateTime? toRange,  String? searchValue)  $default,) {final _that = this;
switch (_that) {
case _BingeFilter():
return $default(_that.watchType,_that.fromRange,_that.toRange,_that.searchValue);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( BingeFilterWatchType watchType,  DateTime? fromRange,  DateTime? toRange,  String? searchValue)?  $default,) {final _that = this;
switch (_that) {
case _BingeFilter() when $default != null:
return $default(_that.watchType,_that.fromRange,_that.toRange,_that.searchValue);case _:
  return null;
...
class _BingeFilter extends BingeFilter {
  const _BingeFilter({required this.watchType, required this.fromRange, required this.toRange, required this.searchValue}): super._();
...
/// Create a copy of BingeFilter
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? watchType = null,Object? fromRange = freezed,Object? toRange = freezed,Object? searchValue = freezed,}) {
