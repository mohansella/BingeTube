...
class VideoSnippets extends Table
  ...
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES videos(id)ON DELETE CASCADE',
  );
...
class ChannelSearchVsChannels extends Table
  ...
  late final GeneratedColumn<int> searchId = GeneratedColumn<int>(
    ...
    requiredDuringInsert: true,
    $customConstraints:
        'NOT NULL REFERENCES channel_searches(id)ON DELETE CASCADE',
  );
  late final GeneratedColumn<String> channelId = GeneratedColumn<String>(
    'channel_id',
    aliasedName,
...
class VideoSearchVsVideos extends Table
  ...
  late final GeneratedColumn<int> searchId = GeneratedColumn<int>(
    ...
    requiredDuringInsert: true,
    $customConstraints:
        'NOT NULL REFERENCES video_searches(id)ON DELETE CASCADE',
  );
  late final GeneratedColumn<String> videoId = GeneratedColumn<String>(
    'video_id',
    aliasedName,
